...
if ($search !== '') {
    ...
    // Fetch logs for current page with search
...
.header{
    ...
    z-index: 1000;
            ...
            .entries-search {
                margin: 10px;
                display: flex;
                justify-content: right; /* Spread left and right */
                align-items: center;
                gap: 10px;
            }
    ...
    <?php if (mysqli_num_rows($result) > 0): ?>
        ...
        <tr>
            ...
            <td class="<?php
                ...
                if ($action === 'delete') echo 'action-delete';
                elseif ($action === 'update') echo 'action-update';
                elseif ($action === 'create') echo 'action-create';
                elseif ($action === 'download') echo 'action-download';
                elseif ($action === 'restore') echo 'action-restore';
