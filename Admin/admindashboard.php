...
.cards {
    ...
    width: calc(33.333% - 20px); /* Responsive width for 3 cards per row with gap */
    padding: 20px;
    text-align: left;
...
.cards p {
    font-size: 16px;
    color: #666; /* Slightly lighter text color for numbers */
}
...
.report-dropdown.show .fa-chevron-right {
    transform: rotate(90deg); /* Rotate the caret when dropdown is open */
}
