...
<body>
   ...
   <div class="card">
    <h2 style="text-align:center; margin-bottom: 32px; color: #003D73; font-size: 2rem; letter-spacing: 1px;">Archives</h2>
    <div style="display: flex; gap: 32px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="fire_safety_inspection_certificate.php" style="text-decoration: none;">
            <div style="border-radius: 14px; padding: 36px 48px; box-shadow: 0 2px 12px rgba(41,128,185,0.10); display: flex; flex-direction: column; align-items: center; background: #f0f7ff; transition: transform 0.2s, box-shadow 0.2s;">
                ...
                <a href="recycle_bin.php" style="text-decoration: none;">
            <div style="border-radius: 14px; padding: 36px 48px; box-shadow: 0 2px 12px rgba(41,128,185,0.10); display: flex; flex-direction: column; align-items: center; background: #f0f7ff; transition: transform 0.2s, box-shadow 0.2s;">
            <i class="fa-solid fa-recycle" style="font-size: 2.5rem; color: #70E000; margin-bottom: 10px;"></i>
            <span style="font-size: 1.15rem; color: #70E000; font-weight: 600; margin-bottom: 6px;">Recycle Bin</span>
                <span style="font-size: 0.95rem; color: #555; text-align: center;">Restore deleted reports.</span>
            </div>
        </a>
    </div>
</div>
