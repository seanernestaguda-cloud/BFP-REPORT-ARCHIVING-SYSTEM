...
<img class="avatar" src="<?php $avatarPath = '../avatars/' . ($user['avatar'] ? $user['avatar'] : 'default_avatar.png'); echo file_exists($avatarPath) ? $avatarPath : '../avatars/default_avatar.png';?>" alt="Avatar" style="width:140px;height:140px;border-radius:50%;border:4px solid #e3e6ea;object-fit:cover;margin-bottom:18px;">
