...
<fieldset>
    ...
    <div class="form-group-container" style="margin-bottom: 0;">
        <label style = "font-weight: bold; display: block; margin-bottom: 5px; color:#003D73;">Required Attachments</label>
        <div class="tab-container">
            ...
            <button type="button" class="tab-btn" onclick="showTab('business_permit_section')">Business Permit</button>
        </div>
    </div>
