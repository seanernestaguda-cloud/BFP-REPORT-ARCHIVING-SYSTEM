...
$query = "SELECT report_id, report_title, street, purok, fire_location, municipality, incident_date, establishment, victims, firefighters, property_damage, fire_types FROM fire_incident_reports $where_sql ORDER BY $sort_by $order_by";
...
// Header
$headers = ['Report ID', 'Report Title', 'Street', 'Purok', 'Barangay', 'Municipality', 'Incident Date', 'Establishment', 'Victims', 'Firefighters', 'Property Damage', 'Cause of Fire'];
