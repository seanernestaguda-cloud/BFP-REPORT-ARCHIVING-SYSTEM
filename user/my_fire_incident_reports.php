...
.side-by-side {
    ...
    gap: 15px; /* Adjust space between the fields */
}
...
.entries-search select, .entries-search input {
    padding: 5px 10px;
    font-size: 14px;
}
...
.search-input {
  width: 220px;
  padding-left: 32px; /* Make space for the icon */
}
...
<div class="dashboard">
    ...
    <div id="sortMenu" style="display:none; position:absolute; left:0; top:110%; background:white; border:1px solid #ccc; border-radius:6px; z-index:10; min-width:120px;">
        <a href="?sort_by=report_id" class="select-multi-btn" style="width:100%; text-align:left; border-radius:0; border-bottom:1px solid #eee; text-decoration: none;">ID</a>
        <a href="?sort_by=report_title" class="select-multi-btn" style="width:100%; text-align:left; border-radius:0; border-bottom:1px solid #eee; text-decoration: none;">Title</a>
        <a href="?sort_by=incident_date" class="select-multi-btn" style="width:100%; text-align:left; border-radius:0; border-bottom:1px solid #eee; text-decoration: none;">Time & Date</a>
        <a href="?sort_by=fire_location" class="select-multi-btn" style="width:100%; text-align:left; border-radius:0; text-decoration: none;">Barangay</a>
    </div>
</div>
 ...
 <div id="monthFilterContainer" style="display:none;">
    <form action="fire_incident_report.php" method="GET" style="display: flex; gap: 8px; align-items: center;">
      <label>
...
?>
            ...
            <button class="view-btn" onclick="window.location.href='view_my_report.php?report_id=<?php echo $row['report_id']; ?>'">
